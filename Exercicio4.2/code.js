...
console.log(anaBday)
console.log(anaBday.format)

anaBday.fromDate = '20 Nov 2025'
anaBday.toDate = '23 Nov 2025'

console.log(anaBday.initialDate.toLocaleDateString('pt-pt'), anaBday.finalDate.toLocaleDateString('pt-pt'))

console.log(anaBday.postpone(0,0,5))